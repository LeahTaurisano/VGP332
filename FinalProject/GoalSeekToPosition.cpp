...
void GoalSeekToPosition::Activate(Gatherer& agent)
{
...
GoalSeekToPosition::Status GoalSeekToPosition::Process(Gatherer& agent)
{
...
void GoalSeekToPosition::Terminate(Gatherer& agent)
{
	agent.SetSeek(false);
}
